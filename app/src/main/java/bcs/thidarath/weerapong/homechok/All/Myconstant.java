...
public class Myconstant {
    ...
    private String urlpostUserString = "http://androidthai.in.th/12Sep/userNop.php";

    private String urlgetUserString = "http://androidthai.in.th/12Sep/getAllUserNop.php";
